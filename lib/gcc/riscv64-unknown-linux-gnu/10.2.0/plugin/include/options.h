...
enum opt_code
{
  ...
  OPT_mglibc = 1605,                         /* -mglibc */
  OPT_mmusl = 1606,                          /* -mmusl */
  OPT_mplt = 1607,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1608,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1609,                         /* -mrelax */
  OPT_mriscv_attribute = 1610,               /* -mriscv-attribute */
  ...
  OPT_muclibc = 1616,                        /* -muclibc */
  OPT_n = 1617,                              /* -n */
  OPT_name_sort = 1618,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1619,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1620,              /* -no-integrated-cpp */
  OPT_no_pie = 1621,                         /* -no-pie */
  OPT_nocpp = 1622,                          /* -nocpp */
  OPT_nodefaultlibs = 1623,                  /* -nodefaultlibs */
  OPT_nolibc = 1624,                         /* -nolibc */
  OPT_nophoboslib = 1625,                    /* -nophoboslib */
  OPT_nostartfiles = 1626,                   /* -nostartfiles */
  OPT_nostdinc = 1627,                       /* -nostdinc */
  OPT_nostdinc__ = 1628,                     /* -nostdinc++ */
  OPT_nostdlib = 1629,                       /* -nostdlib */
  OPT_o = 1630,                              /* -o */
  OPT_objects = 1631,                        /* -objects */
  OPT_p = 1632,                              /* -p */
  OPT_pass_exit_codes = 1633,                /* -pass-exit-codes */
  /* OPT_pedantic = 1634, */                 /* -pedantic */
  OPT_pedantic_errors = 1635,                /* -pedantic-errors */
  OPT_pg = 1636,                             /* -pg */
  OPT_pie = 1637,                            /* -pie */
  OPT_pipe = 1638,                           /* -pipe */
  OPT_posix = 1639,                          /* -posix */
  OPT_print_file_name_ = 1640,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1641,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1642,          /* -print-multi-directory */
  OPT_print_multi_lib = 1643,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1644,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1645,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1646,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1647,               /* -print-prog-name= */
  OPT_print_search_dirs = 1648,              /* -print-search-dirs */
  OPT_print_sysroot = 1649,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1650,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1651,                    /* -print-value */
  OPT_profile = 1652,                        /* -profile */
  OPT_pthread = 1653,                        /* -pthread */
  OPT_quiet = 1654,                          /* -quiet */
  OPT_r = 1655,                              /* -r */
  OPT_rdynamic = 1656,                       /* -rdynamic */
